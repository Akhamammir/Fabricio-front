...
class EMOT extends React.Component {
  constructor(props) {
    ...
    this.state = {usr:this.props.location.state,
      score:[{score:0, Name:'Inteigencia Lingusitica', Prioridad:1, points:[], perc:0, key:'Ling'}, {score:0, Name:'Inteigencia Logico-Matematica', Prioridad:2, points:[], perc:0, key:'Math'},
      {score:0, Name:'Inteigencia Espacial', Prioridad:3, points:[], perc:0, key:'Space'}, {score:0, Name:'Inteigencia Fisica-Kinestesica', Prioridad:4, points:[], perc:0, key:'Phys'},
      {score:0, Name:'Inteigencia Musical', Prioridad:5, points:[], perc:0, key:'Music'}, {score:0, Name:'Inteigencia Interpersonal', Prioridad:6, points:[], perc:0, key:'Pers'} ],
  ...
  upload = () =>{
    ...
    axios.post('/actUp', {usr:this.state.usr, what:what, act:this.state}).then(res => {
      Alert.success('La actividad se cargo con exito.')
    });
  }
            ...
            >
              ...
              <Box gridArea="st4" background="#272829">
                ...
                <Input
                  ...
                  onChange = {(event) => this.handleChange(event, 'square') }
                />
                <br/>
                <Paragraph margin="none" fill={true} style={{textAlign:"justify"}}>
                ...
                <Input
                  ...
                  onChange = {(event) => this.handleChange(event, 'zoq') }
                />
                <br/><br/>
                ...
                <Input
                  ...
                  onChange = {(event) => this.handleChange(event, 'ball') }
                />
                <br/><br/>
                ...
                <Input
                  ...
                  onChange = {(event) => this.handleChange(event, 'cat') }
                />
                <br/><br/>
                <Paragraph margin="none" fill={true} style={{textAlign:"justify"}}>
              ...
              <Box gridArea="Graph" background="#272829">
                ...
                <Input
                  ...
                  onChange = {(event) => this.handleChange(event, 'card') }
                />
                <br/>
                <Paragraph margin="none" fill={true} style={{textAlign:"justify"}}>
                ...
                <Input
                  ...
                  onChange = {(event) => this.handleChange(event, 'doll') }
                />
                <br/>
                <br/>
                <Button
